...
void RGBCubeScene::initScene()
{
	...
	float positionData[] = {
		//First square
		-0.2f, 0.4f, 0.0f,		// Vertex 0
		-0.2f, 0.8f, 0.0f,		// Vertex 1
		 0.2f, 0.4f, 0.0f,		// Vertex 2
		 0.2f, 0.8f, 0.0f,	    // Vertex 3
		 //Second square
		-0.2f, 0.4f, 0.0f,		// Vertex 4
		-0.2f, 0.0f, 0.0f,		// Vertex 5
		 0.2f, 0.4f, 0.0f,		// Vertex 6
		 0.2f, 0.0f, 0.0f,		// Vertex 7
		 //Third square
		-0.2f, 0.0f, 0.0f,		// Vertex 8
		 0.2f, 0.0f, 0.0f,		// Vertex 9
		-0.2f, -0.4f, 0.0f,		// Vertex 10
		 0.2f, -0.4f, 0.0f,		//Vertex 11
		 //Fourth square
		-0.2f, -0.4f, 0.0f,		// Vertex 12
		 0.2f, -0.4f, 0.0f,		// Vertex 13
		-0.2f, -0.8f, 0.0f,		// Vertex 14
		 0.2f, -0.8f, 0.0f,		//Vertex 15
		 //Fifth square
		 0.2f, -0.4f, 0.0f,		//Vertex 16
		 0.6f, -0.4f, 0.0f,		// Vertex 17
		 0.2f, -0.8f, 0.0f,		// Vertex 18
		 0.6f, -0.8f, 0.0f,		// Vertex 19
		 //Sixth square
		-0.2f, -0.4f, 0.0f,		// Vertex 20
		-0.6f, -0.4f, 0.0f,		// Vertex 21
		-0.2f, -0.8f, 0.0f,		// Vertex 22
		-0.6f, -0.8f, 0.0f,		// Vertex 23
	};
	...
	GLuint indices[] = { 
		...
		5,7,6,//anticlockwise
		8,9,10,//clockwise 
		10,11,9,//anticlockwise
		12,13,14,//clockwise 
		14,15,13,//anticlockwise
		16,17,18,//clockwise 
		18,19,17,//anticlockwise
		21,20,23,//clockwise 
		23,22,20//anticlockwise
	};
